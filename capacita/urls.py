...
urlpatterns = [
    ...
    url(r'^plano/(?P<pk>\d+)/$', views.plano_delete, name='plano_delete'),
    url(r'^plano/(?P<pk>\d+)/show/$', views.plano_show, name='plano_show'),
    url(r'^treinamentos/$', views.treinamentos, name='treinamentos'),
    url(r'^treinamento/(?P<pk>\d+)/$', views.treinamento_delete, name='treinamento_delete'),
    ...
    url(r'^orgao/(?P<pk>\d+)/$', views.orgao_delete, name='orgao_delete'),
    url(r'^orgao/new/$', views.orgao_new, name='orgao_new'),
    url(r'^tipos_treinamento/$', views.tipos_treinamento, name='tipos_treinamento'),
    url(r'^tipo_treinamento/(?P<pk>\d+)/edit/$', views.tipo_treinamento_edit, name='tipo_treinamento_edit'),
    url(r'^tipo_treinamento/new/$', views.tipo_treinamento_new, name='tipo_treinamento_new'),
    url(r'^tipo_treinamento/(?P<pk>\d+)/$', views.tipo_treinamento_delete, name='tipo_treinamento_delete'),
    url(r'^areas/$', views.areas, name='areas'),
    url(r'^area/(?P<pk>\d+)/$', views.area_delete, name='area_delete'),
    ...
    url(r'^objetivo/(?P<pk>\d+)/$', views.objetivo_delete, name='objetivo_delete'),
