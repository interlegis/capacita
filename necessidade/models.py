...
class Necessidade(models.Model):
    ...
    hor_duracao = models.DecimalField(max_digits=3, decimal_places=0, validators=[MinValueValidator(1)], null=True)
    cod_prioridade = models.ForeignKey('capacitaApp.Prioridade', models.DO_NOTHING)
    qtd_servidor = models.DecimalField(max_digits=6, decimal_places=0, validators=[MinValueValidator(1)])
