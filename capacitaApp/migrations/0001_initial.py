    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orgao_ativo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='orgao.Orgao')),
                ('orgaos', models.ManyToManyField(related_name='orgao_gestor', to='orgao.Orgao')),
